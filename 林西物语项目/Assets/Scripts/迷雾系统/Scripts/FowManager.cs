...
namespace FogOfWar
{
    public class FowManager : MonoBehaviour
    {
        ...
        public int[] GetPos2(FowViewer viewer)
        {
            //var x = (int)((viewer.transform.position.x - transform.position.x + FogSizeX / 2) / MapTileSize);
            //var y = (int)((viewer.transform.position.y - transform.position.y + FogSizeY / 2) / MapTileSize);
            var x = (int)((viewer.transform.position.x + FogSizeX / 2) / MapTileSize);
            var y = (int)((viewer.transform.position.y + FogSizeY / 2) / MapTileSize);
            //return new int[] { x,y };


            return new int[] { (int)((FogSizeX- x)+ FogSizeX), (int)((FogSizeY-y)+ FogSizeY) };
        }
